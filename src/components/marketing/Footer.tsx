...
const socials = [
  ...
  {
    label: 'Email',
    href: 'mailto:support@skolify.in',
    icon: (
          ...
          <li key={link.href}>
            {link.external ? (
              <a
                ...
                className="text-sm text-slate-500 hover:text-brand-600 transition-colors duration-200 flex items-center gap-1"
              >
                {link.label}
              ...
              <Link
                href={link.href}
                className="text-sm text-slate-500 hover:text-brand-600 transition-colors duration-200"
              >
                {link.label}
              </Link>
            )}
...
export function Footer() {
  return (
    <footer className="relative border-t border-slate-200 bg-slate-50" role="contentinfo">
      {/* Decorative top line */}
